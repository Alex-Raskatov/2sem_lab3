...
int main() {
    ...
    DynamicArray da_1 = new_array(10);
    DynamicArray da_3 = new_array(10);
    DynamicArray da_2 = new_array(10);
    DynamicArray &da_1_ref = da_1, &da_2_ref = da_2, &da_3_ref = da_3;

    unsigned start = 0, stop = 1000000;
